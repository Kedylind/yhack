...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const logout = useCallback(() => {
    setState({ isAuthenticated: false, user: null, profile: null, insurance: null, onboardingComplete: false });
  }, []);
  ...
  return (
    <AuthContext.Provider value={{ ...state, login, signup, logout, setProfile, setInsurance, completeOnboarding }}>
      {children}
