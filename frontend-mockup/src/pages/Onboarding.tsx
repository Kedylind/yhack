...
const SPECIALTIES = [
  'Primary Care', 'Dermatology', 'Cardiology', 'Orthopedics', 'OB/GYN',
  'Pediatrics', 'Psychiatry', 'Physical Therapy', 'Urgent Care', 'Dental',
];
...
const Onboarding = () => {
  ...
  const { setProfile: saveProfile, setInsurance: saveInsurance, completeOnboarding } = useAuth();
  ...
  const submit = () => {
    ...
    completeOnboarding();
    // TODO: POST to API_BASE_URL/onboarding
    setDone(true);
  };
